  ...
  group('Values', () {
    ...
    group('Integer', () {
      ...
      testValue(
        ...
        output: -17);
      testValueFailure(
        'leading zeros atre not allowed',
        input: '0777');
      testValue(
        'underscore',
        input: '1_000',
      ...
      testValue(
        ...
        output: 5349221);
      testValue(
        'inadvisable usage of underscores',
        input: '1_2_3_4_5',
        output: 12345);
      testValueFailure(
    ...
    group('Float', () {
      ...
      testValue(
        ...
        output: -0.01);
      testValue(
        'positve exponent part',
        input: '5e+22',
        output: 5e+22);
      testValue(
        'plus sign of exponent part is optional',
        input: '1e6',
        output: 1e6);
      testValue(
        'negative number',
        ...
        output: -2E-2);
      testValue(
        'fractional and exponent part',
        input: '6.626e-34',
        output: 6.626e-34);
      testValue(
        'underscores in integer and fractional part',
        input: '9_224_617.445_991_228_313',
        output: 9224617.445991228313);
      testValue(
    ...
    group('Array', () {
      ...
      testValue(
        'array of arrays of the same type',
        input: '[ [ 1, 2 ], [3, 4, 5] ]',
        output: [[1, 2], [3, 4, 5]]);
      testValue(
        'array of arrays of different types',
        input: '[ [ 1, 2 ], ["a", "b", "c"] ]',
        output: [[1, 2], ['a', 'b', 'c']]);
      testValue(
        'there can be newlines in an array',
        input: '''[
          1, 2, 3
        ]''',
        output: [1, 2, 3]);
      testValue(
        'there can be comments in an array',
        input: '''[
          1,
          2, # this is ok
        ]''',
        output: [1, 2]);
      testValueFailure(
        'arrays of mixed types are not allowed',
        input: '[ 1, 2.0 ]');
      testValueFailure(
