...
///
///     ws = *wschar
final Parser<String> tomlWhitespace = tomlWhitespaceChar.starString().orFailure(
  'whitespace expected',
);
...
final Parser<String> tomlWhitespaceChar = ChoiceParser([
  char(' '),
  char('\t'),
...
///     newline =  %x0A     ; LF
///     newline =/ %x0D.0A  ; CRLF
final Parser<String> tomlNewline = ChoiceParser([
  char('\n'),
  string('\r\n'),
...
final Parser tomlComment = (char('#') & tomlNonEol.star()).orFailure(
  'comment expected',
);
