...
class TomlDocumentBuilder {
  ...
  void encodeValue(value) {
    ...
    if (encoder == null) {
      throw new UnknownValueTypeError(value);
    }
    encoder(value);
  }
  ...
  TomlValueEncoder<String> getStringEncoder(String value) {
    var allowedEscSeq = [
      TomlGrammar.escTable['"'], 
      TomlGrammar.escTable['\\']
    ];
    
    bool containsEscSeq(String s) => 
        TomlGrammar.escTable.values.where(
          (codeUnit) => !allowedEscSeq.contains(codeUnit)
  ...
  void _string(String value, {
    ...
    if (!esc.contains(quotes.codeUnitAt(0)) && 
  ...
  void basicString(String value) =>
      _string(
          value,
          quotes: '"',
          esc: TomlGrammar.escTable.values);

  /// Encodes [value] as a multi-line basic string.
  void multiLineBasicString(String value) =>
      _string(
          value, 
          quotes: '"""',
  ...
  void literalString(String value) =>
      _string(
          value, 
          quotes: "'");
